...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "modelo_ecg_sem_balanceamento_final_perchannel_quant_int8_int8_quant_dataset_from_train_new_npz_1"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x85112d68d16cf2dde4e6321bc6115286"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x3d6f51527f545bf5)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,306,1}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_HEIGHT      (306)
#define STAI_NETWORK_IN_1_CHANNEL     (1)
#define STAI_NETWORK_IN_1_RANK        (2)
#define STAI_NETWORK_IN_1_SIZE        (306)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (306)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (5224)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (5224)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (5224)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (5224)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (38460)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (38460)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (38460)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (38460)
